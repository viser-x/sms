                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Group
                                        </span>
                            <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> SMS Sent
                                        </span>
                            <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Contact
                                        </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                 src="{{ asset('adminAsset') }}/img/undraw_posting_photo.svg" alt="...">
                        </div>
